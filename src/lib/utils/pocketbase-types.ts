...
export type FlashcardResponse<Texpand = unknown> = Required<FlashcardRecord> & BaseSystemFields<Texpand>
export type FlashcardBoxesResponse<Texpand = unknown> = Required<FlashcardBoxesRecord> & BaseSystemFields<Texpand>
export type FlashcardCollectionsResponse<Texpand = unknown> = Required<FlashcardCollectionsRecord> & BaseSystemFields<Texpand>
export type FlashcardCountResponse<Texpand = unknown> = Required<FlashcardCountRecord> & BaseSystemFields<Texpand>
export type PostsResponse<Tcontent = unknown, Texpand = unknown> = Required<PostsRecord<Tcontent>> & BaseSystemFields<Texpand>
export type QuizProgressResponse<TprogressData = unknown, Texpand = unknown> = Required<QuizProgressRecord<TprogressData>> & BaseSystemFields<Texpand>
export type QuizzesResponse<Tflashcards = unknown, Texpand = unknown> = Required<QuizzesRecord<Tflashcards>> & BaseSystemFields<Texpand>
export type SearchesResponse<Texpand = unknown> = Required<SearchesRecord> & BaseSystemFields<Texpand>

...
<Drawer.Root>
	...
	>
		<div class="mx-auto flex w-full max-w-md flex-col overflow-auto rounded-t-[10px] p-4">
			<Input class="my-8 border border-gray-400" placeholder="Input" value="This is a value" />
			<p>
			...
			<Input value="This is a value" class="my-8 border border-gray-400" placeholder="Input" />
		</div>
	</Drawer.Content>
</Drawer.Root>
